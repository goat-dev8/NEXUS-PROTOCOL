...
contract NexusFactory is Ownable {
    ...
    /// @notice Address of the privacy pool contract
    ...
    /**
     * @notice Sets the privacy pool address
     * @param _privacyPool Address of the NexusPrivacyPool contract
     */
    function setPrivacyPool(address _privacyPool) external onlyOwner {
        require(_privacyPool != address(0), "Invalid address");
        privacyPool = _privacyPool;
    }

    /**
     * @notice Gets the privacy pool address
     * @return Address of the privacy pool
     */
    function getPrivacyPool() external view returns (address) {
        return privacyPool;
    }
}
